...
export default function ArtisansPage() {
  ...
  const artisans = [
    {
      ...
      avatar: "/indian-woman-weaving-colorful-textiles.jpg",
      coverImage: "/indian-woman-weaving-colorful-textiles.jpg",
      rating: 4.9,
      reviews: 127,
      products: 23,
      yearsExperience: 15,
    ...
    },
    {
      ...
      avatar: "/mexican-potter-working-with-clay.jpg",
      coverImage: "/mexican-potter-working-with-clay.jpg",
      rating: 4.8,
      reviews: 89,
      products: 31,
      yearsExperience: 22,
    ...
    },
    {
      ...
      avatar: "/african-woman-carving-wood-sculpture.jpg",
      coverImage: "/african-woman-carving-wood-sculpture.jpg",
      rating: 4.7,
      reviews: 156,
      products: 18,
      yearsExperience: 12,
  ...
  const filteredArtisans = artisans.filter((artisan) => {
    ...
    const matchesCraft =
      ...
      artisan.craftType === selectedCraft;
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Connect with skilled craftspeople from around the world. Each
            artisan brings generations of traditional knowledge and unique
            cultural perspectives to their craft.
          </p>
        </div>
                ...
                >
                  <div className="relative h-48">
                    <Image
                      src={
                        artisan.coverImage ||
                        "/placeholder.svg?height=200&width=400&query=artisan+workshop"
                      }
                    ...
                    <div className="flex items-start gap-4">
                      <Avatar className="w-16 h-16">
                        <AvatarImage
                          src={
                            artisan.avatar ||
                            "/placeholder.svg?height=64&width=64&query=artisan+avatar"
                          }
                          alt={artisan.name}
                        />
                        <AvatarFallback>
              ...
              >
                <div className="relative h-32">
                  <Image
                    src={
                      artisan.coverImage ||
                      "/placeholder.svg?height=128&width=300&query=artisan+workshop"
                    }
                    alt={`${artisan.name}'s workshop`}
                    fill
                    className="object-cover"
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    <Avatar className="w-12 h-12">
                      <AvatarImage
                        src={
                          artisan.avatar ||
                          "/placeholder.svg?height=48&width=48&query=artisan+avatar"
                        }
                        alt={artisan.name}
                      />
                      <AvatarFallback>
                  ...
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    {artisan.languages.length > 2 && (
                      <span className="text-xs text-gray-500">
                        +{artisan.languages.length - 2} more
                      </span>
                    )}
                  </div>
